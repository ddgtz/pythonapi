...
class Invoices(Resource):
    # Step 1. Define a page size here
    def get(self):
        # Step 2. Retrieve the page parameter using Flask's request.args dictionary
        # Step 3. Invoke the InvoiceModel.query.paginate() method passing the page and page_size methods
        # Step 4. In the return below, pass the paginate_obj.items attribute into dump()
        # Step 5. Test the solution by running the provided task3_1_client.py file
        return {'results': invoices_schema.dump()}
